...
class BPSConfig:
    ...
    train_meta_fname:   str = 'meta_type_X-ray_hr_4_post_exposure_train.csv'
    val_meta_fname:     str = 'meta_type_X-ray_hr_4_post_exposure_test.csv'
...
def main():
    ...
    model_path = "xray_trained_CNN_model.pth"
